	...
	render(view, menu) {
		...
		function update(state, view) {
			...
			if (spec.menu) {
				...
				const after = $pos.parent.maybeChild($pos.index());
				let marks = [];
				if (after && after.isInline) {
					marks = after.marks.filter((mark) => mark.type.name == spec.type);
				}
...
export const icons = {
	...
	embed: {
		width: 1025, height: 840,
		path: "m737 101-96 96 224 224-224 224 96 96 288-320zm-449 0L0 421l288 320 96-96-224-224 224-224z M560 1 393 840h72L635 1Z"
	},
	sup: {
