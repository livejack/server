module.exports = [{
	...
	endpoints: [{
		...
		redirect(obj) {
			...
			// to do things right, we need to grab policy_key field sitting in the index.html page, then do the request :()
			...
			if (videoId) {
				...
				delete obj.search;
				delete obj.query;
				if (accountId == "610043537001") {
					obj.headers.Accept = "application/json;pk=BCpkADawqM2xuJsXaB2RuHdqCOlX1qWL6BnaPiIWZxb_5VZr8AOCHRoMixAy7weiaTeQ6z6YuN7KbZfm8rp39vwCffRWvAXGVFXd-DRzL2mb8VhAehfXACjM2zE";
